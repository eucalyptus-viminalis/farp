...
export default function ReplyIcon() {
    ...
    const handleOnClick = () => {
        ...
        if (cx.castType === "root-cast") {
            return (
        <div 
            className="group flex w-9 flex-row items-center text-sm text-faint cursor-pointer"
            onClick={handleOnClick}
        >
            <div className="group flex flex-row items-center justify-center rounded-full p-2 transition-colors sm:hover:bg-gray-200 sm:group-hover:bg-gray-200 sm:dark:hover:bg-overlay-medium sm:dark:group-hover:bg-overlay-medium text-action-purple  text-faint">
