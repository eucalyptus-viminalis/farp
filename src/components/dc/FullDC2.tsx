...
import CastMessageExample from "./CastMessageExample";
import EmbeddedReplyExample from "./EmbeddedReplyExample";
import FirstHiddenExample from "./FirstHiddenExample";
import MyMessageExample from "./MyMessageExample";
import MyMessageReactedExample from "./MyMessageReactedExample";
import ReplyExample from "./ReplyExample";
import TopNav from "./top-nav/TopNav";
import MyMessage from "./MyMessage";

export default function FullDC2() {
                ...
                <div className="flex h-full flex-col overflow-hidden pl-2">
                    ...
                    >
                        ...
                        >
                            ...
                            <ReplyExample />
                            <MyMessageExample />
                            {/* <MyMessageReactedExample /> */}
                            <MyMessage
                                castText="hey i’ll check it out but dont think l i’ll hav time to participate : /"
                                index={3}
                                time="12:01 PM"
                            />
                            <EmbeddedReplyExample />
                            <CastMessageExample />
                            <FirstHiddenExample />
                        </div>
                    </div>
