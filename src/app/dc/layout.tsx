...
const frame: FrameEmbedNext = {
  ...
  imageUrl: `${appConfig.hostUrl}/dc/opengraph-image.png`, // the image to be displayed before user launches the frame
  ...
  button: {
    ...
    action: {
      ...
      url: appConfig.hostUrl + "/dc", // opens this url in the in-app browser
