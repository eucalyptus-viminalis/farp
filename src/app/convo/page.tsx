...
import ConvoRootCast from "../(cast)/_ui/ConvoRootCast";
import NestedReplyCast from "../(cast)/_ui/NestedReplyCast";
import ReplyCast from "../(cast)/_ui/ReplyCast";
      ...
      <div className="h-full w-full">
        <div className="h-full min-h-screen border-default sm:border-x">
          ...
          <div className="fade-in">
            ...
            <NestedReplyCast cast={exampleNestedReply2} lastToDisplay />
            <ReplyCast cast={exampleReply2} lastIndex lastToDisplay />
          </div>
        </div>
      </div>
    </main>
