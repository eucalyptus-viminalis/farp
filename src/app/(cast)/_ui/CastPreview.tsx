...
import CastHeaderPreview from "./CastHeaderPreview";
        ...
        <div className="relative">
          <div
            className={`relative px-4 py-2 hover:bg-overlay-faint ${
              castType === "nested-reply" ? "pl-14" : "border-t border-faint"
            }`}
          >
            {previewMode === "expanded-web" && castType === "nested-reply" && (
              <div
            ...
            <div className="relative flex flex-col">
              <div className="relative flex">
                ...
                {/* Main Content */}
                {previewMode === "expanded-web" && castType === "root-cast" && (
                  <div className="pl-3">
                    <DisplayNameConvo />
