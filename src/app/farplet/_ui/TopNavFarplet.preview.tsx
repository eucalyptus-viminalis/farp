...
export default function TopNavFarplet() {
  ...
  return (
    <nav className="sticky top-0 z-10 flex-col border-b-0 bg-app border-default sm:border-b sm:border-b-0">
      <div className="flex sm:flex sm:px-4 h-20 flex-row items-center justify-between">
        <div className="w-full h-full">
          <div className="flex w-full h-full flex-row justify-between">
            ...
            >
              <span className="text-2xl font-semibold">Warplet</span>

              <span className="text-lg text-[#576472] dark:text-[#9FA3AF]">
                {formatAddress(addy)}
              </span>
            </div>
